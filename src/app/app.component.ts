...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, DisplayComponent, CounterComponent, ListFruitComponent, ListStudentComponent, TodoParentComponent, BookAddComponent, BookEditComponent, ParentComponent, AppHeaderComponent],
